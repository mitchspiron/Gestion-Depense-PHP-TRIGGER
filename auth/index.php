<?php
// Vérifie si l'utilisateur est déjà connecté, si oui il se redirige vers le dashboard
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Rebonjour !</h1>
                                    </div>
                                    <form class="user" method="POST" action="controller/login.php">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control form-control-user"
                                                id="password" placeholder="Entrez votre mot de passe" required>
                                        </div>
